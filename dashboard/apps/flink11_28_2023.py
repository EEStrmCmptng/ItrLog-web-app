...
loc='/home/handong/flink/11_28_2023/'
workload_loc='/home/handong/flink/11_28_2023/combined.csv'
...
def genfigtype11_28(i):
    return html.Div([
        dcc.Dropdown(id=f'figtype11_28-xselector-{i}', value='SourcenumRecordsOutPerSecond_avg', style={'width':'60%'}, options=axis_values),
        dcc.Dropdown(id=f'figtype11_28-yselector-{i}', value='joules', style={'width':'60%'}, options=axis_values),        
        dcc.Graph(
            id=f'figtype11_28-scatter-{i}', style={'display': 'inline-block'}
        )
    ], style={'display': 'inline-block'})
'''
def genintlogfig11_28(i):
    return html.Div([
        dcc.Textarea(
            id='intlogfig11_28-textarea-'+str(i),
            value=str(i-1),
            style={'width': '10%'},
            #disabled=True,
            readOnly=True,
...
layout = html.Div([
    ...
    dbc.Row([        
        dbc.Col(children=[genfigtype11_28(i) for i in range(1,3)])
    ]),
    ...
    #dbc.Row([        
    #    dbc.Col(children=[genintlogfig11_28(i) for i in range(1,17)])
    #])
])

for i in range(1, 3):
    @app.callback(
        Output('figtype11_28-scatter-'+str(i), 'figure'),
        [Input('figtype11_28-xselector-'+str(i), 'value'),
         Input('figtype11_28-yselector-'+str(i), 'value')]
    )
...
for i in range(1, 3):
    @app.callback(
        Output(f'intlogfig11_28-{i}', 'figure'),
        [Input(f'intlogfig11_28-rate-{i}', 'value'),
         Input(f'intlogfig11_28-itera-{i}', 'value'),
         Input(f'intlogfig11_28-nmappers-{i}', 'value'),
         Input(f'intlogfig11_28-yaxis-{i}', 'value'),
         Input(f'intlogfig11_28-textarea-{i}', 'value')]
    )
...
@app.callback(
    [Output('intlogfig11_28-1', 'figure'),
     Output('intlogfig11_28-2', 'figure'),
     Output('intlogfig11_28-3', 'figure'),
     Output('intlogfig11_28-4', 'figure'),
     Output('intlogfig11_28-5', 'figure'),
     Output('intlogfig11_28-6', 'figure'),
     Output('intlogfig11_28-7', 'figure'),
     Output('intlogfig11_28-8', 'figure'),
     Output('intlogfig11_28-9', 'figure'),
     Output('intlogfig11_28-10', 'figure'),
     Output('intlogfig11_28-11', 'figure'),
     Output('intlogfig11_28-12', 'figure'),
     Output('intlogfig11_28-13', 'figure'),
     Output('intlogfig11_28-14', 'figure'),
     Output('intlogfig11_28-15', 'figure'),
     Output('intlogfig11_28-16', 'figure')],
    [Input('intlogfig11_28-rate-1', 'value'),
     Input('intlogfig11_28-itera-1', 'value'),
     Input('intlogfig11_28-nmappers-1', 'value'),
     Input('intlogfig11_28-yaxis-1', 'value'),
     Input('intlogfig11_28-textarea-1', 'value')]
)
def update_intlogagg(rate, itera, nmappers, yaxis, core):
    figs = []
