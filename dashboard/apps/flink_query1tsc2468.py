...
uname='query1tsc2468'
loc=f'/home/handong/flink/{uname}'
workload_loc=f'/home/handong/flink/{uname}/combined.csv'
...
def update_intlogagg(rate, itera, nmappers, yaxis, core):
    ...
    for cc in range(1, 17):
        ...
        fname=f"/home/handong/flink/{uname}/{uname}_cores16_frate{rate}_300000_fbuff-1_itr1_ondemanddvfs1_source16_mapper{nmappers}_sink16_repeat{itera}/ITRlogs/linux.flink.dmesg._{cc-1}_{itera}"
